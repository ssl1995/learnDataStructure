package codingGuide.第0章_牛客算法课.初级班.课13_有序表;
...
public class SizeBalancedTreeMap {
    ...
    public static class SizeBalancedTreeMap1<K extends Comparable<K>, V> {
    ...
    public static void main(String[] args) {
        SizeBalancedTreeMap1<String, Integer> sbt = new SizeBalancedTreeMap1<String, Integer>();
        sbt.put("d", 4);
        sbt.put("c", 3);
        sbt.put("a", 1);
        sbt.put("b", 2);
